    ...
    return (
      <>
        <div className="w-full h-max flex justify-center items-center flex-col gap-5 md:flex-row md:p-5 xl:p-0 gap-10">
          <div className="bg-black w-64 h-56 rounded-xl flex flex-col items-center">
            ...
            <button className="bg-blue-400 px-4 mt-6">JOIN NOW @499</button>
          </div>
          ...
          <div className="bg-green-300 w-64 h-56 rounded-xl flex flex-col items-center">
            ...
            <button className="bg-blue-400 px-4 mt-6">JOIN NOW @699</button>
          </div>
          ...
          <div className="bg-green-300 w-64 h-56 rounded-xl flex flex-col items-center">
            ...
            <button className="bg-blue-400 px-4 mt-6">JOIN NOW @2499</button>
          </div>
        </div>
      </>
    );
